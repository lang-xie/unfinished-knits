  ...
  return (
    <section id="listing" className="bg-amber-200/10">
      ...
      <ul className="px-8 mx-auto max-w-md sm:flex sm:gap-x-16 sm:justify-start sm:gap-y-8 sm:max-w-xl md:max-w-5xl">
        {products.map((p) => (
          <li className="mb-6 shadow rounded-2xl flex flex-col content-between bg-white px-2 py-4 sm:basis-1/2 md:basis-1/3 md:max-h-[300px] md:justify-center md:text-center">
            <img
              src={p.imageURL}
              alt={p.title}
